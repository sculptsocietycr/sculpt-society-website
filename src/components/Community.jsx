...
import { community, images } from '../data/content';
      ...
      <div className="container-site relative">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          >
            ...
            <div className="mt-12 hidden overflow-hidden rounded-2xl lg:block">
              <img src={images.community} alt="Movimiento Sculpt Society" className="h-80 w-full object-cover" />
            </div>
          </motion.div>
